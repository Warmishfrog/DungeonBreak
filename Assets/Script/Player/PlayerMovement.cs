...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        grounded = Physics.CheckSphere(groundCheckPosition, groundCheckDistance, whatIsGround);
        ...
        else rb.linearDamping = 0f; // No drag when in the air
    ...
    private void Jump()
    {
        ...
        rb.linearVelocity = horizontalVelocity + Vector3.up * jumpForce;
        ...
        if (currentSpeed < maxBunnyhopSpeed)
        {
            ...
            rb.linearVelocity = newHorizontalVelocity + Vector3.up * rb.linearVelocity.y;
        }
